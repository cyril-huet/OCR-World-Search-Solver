...
int main() {
    execute_command("convert grid_only.png grid_only.pgm");
    execute_command("convert list_only.png image_source.png");
    ...
    if (width == 708) 
    {
        ...
        execute_command("convert output.pgm output_with_boxes.png");
        execute_command("./fin");
        ...
        if (width == 250) {
            ...
            execute_command("convert image_source.pgm -depth 8 image_source.pgm && ./facile image_source.pgm");
